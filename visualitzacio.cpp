...
{   
	...
	GLdouble left = -aspecte * escala;
	GLdouble right = aspecte * escala;
	GLdouble top = -escala;
	GLdouble bottom = escala;
	GLdouble vnear = -100;
	GLdouble vfar = 100;
...
//								tipus de projecció definit a la variable prj.
	...
	if (prj == 3)
	{
		MatriuVista = glm::lookAt(
			...
			glm::vec3(0, 0, 0), // and looks here
			glm::vec3(-1, -0.5, -1)  // Head is up (set to 0,-1,0 to look upside-down)
		);
	}
// Pas Matriu a shader
